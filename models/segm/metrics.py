...
def calculate_fid(pred_dir, gt_dir):
    batch_size = 1
    new_batch_size = 1
    incep_pth = os.path.join("/userhome/chengyean/ct2_sos/models/segm/resources/inception_v3_google-1a9a5a14.pth")
    # sys.path.append('/userhome/chengyean/ct2_sos/models/segm')
    # incep_pth = os.path.join('/userhome/chengyean/ct2_sos/models/segm/resources/pt_inception-2015-12-05-6726825d.pth')
