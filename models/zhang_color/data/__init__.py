...
from models.zhang_color.data.base_data_loader import BaseDataLoader
from models.zhang_color.data.base_dataset import BaseDataset
...
def find_dataset_using_name(dataset_name):
    ...
    # will be imported.
    prefix = "models.zhang_color."
    dataset_filename = prefix + "data." + dataset_name + "_dataset"
